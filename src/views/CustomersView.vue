...
<template>
  <AppLayout class="relative p-4" pageTitle="Customers" stateKey="showAddCustomerView" navBtnText="add Customer"
    :hasNavBtn="true">
    ...
    <div v-else class="p-2 ">
      ...
      <div v-else class="overflow-y-scroll h-screen pb-56">
        <div class="select-customer-wrapper  " v-for="(customer, i) in filteredCustomers" :key="i"
